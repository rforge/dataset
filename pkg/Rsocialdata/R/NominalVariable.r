...
setClass(
  ...
  validity = function(object) {
    if(Rsocialdata.globalenv$print.io) cat (" =>       NominalVariable: object validity check \n")
  	flag = TRUE
...
nominalVariable <- function(
  ...
  if(Rsocialdata.globalenv$print.io) cat(" => (in)  NominalVariable: builder \n")
  ...
  if(Rsocialdata.globalenv$print.io) cat(" => (out) NominalVariable: builder \n")
  return(out)
}
