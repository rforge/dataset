...
setClass(
  ...
  validity = function(object) {
    if(Rsocialdata.globalenv$print.io) cat (" =>       ScaleVariable: object validity check \n")
    flag <- TRUE
...
svar <- function(
  ...
  if(Rsocialdata.globalenv$print.io) cat(" => (in)  ScaleVariable: builder \n")
  ...
  if(Rsocialdata.globalenv$print.io) cat(" => (out) ScaleVariable: builder \n")
  out <- new(
    Class = "ScaleVariable",
    codes = variable$x,
