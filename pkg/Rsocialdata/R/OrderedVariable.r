...
setClass(
  ...
  validity = function(object) {
    if(Rsocialdata.globalenv$print.io) cat (" =>       OrderedVariable: object validity check \n")
  	flag <- TRUE
...
#  description
#) {
#  if(Rsocialdata.globalenv$print.io) cat(" => (in)  OrderedVariable: virtual builder\n")
#  if(Rsocialdata.globalenv$print.io) cat(" => (out) OrderedVariable: virtual builder\n")
#}
