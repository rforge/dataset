...
setGeneric("values", function(object, type = "all"){ standardGeneric("values") })
...
setGeneric("sd", function(x, na.rm){stats::sd})
setGeneric("variables", function(object, weighting = TRUE){ standardGeneric("variables") })
...
setGeneric("summaryToPDF", function(object, pdfSavingName, graphics = FALSE, description.chlength = 120, values.chlength = 6, dateformat, keepTex = FALSE){ standardGeneric("summaryToPDF") })
setGeneric("as.Dataset", function(object){ standardGeneric("as.Dataset") })
setGeneric("contains", function(object, ch){ standardGeneric("contains") })
