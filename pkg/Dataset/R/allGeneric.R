...
setGeneric("summaryToPDF", function(object, pdfSavingName, graphics = FALSE, description.chlength = 120, values.chlength = 6, dateformat, latexPackages, keepTex = FALSE){ standardGeneric("summaryToPDF") })
